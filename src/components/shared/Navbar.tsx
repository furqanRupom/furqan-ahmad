...
const Navbar: React.FunctionComponent<INavbarProps> = (props) => {
    ...
    return (
        <nav className='fixed top-0 w-full '>
            <div className='max-w-7xl mx-auto p-4 lg:p-2 lg:rounded-3xl flex justify-between lg:my-5 bg-red-50 dark:bg-red-50 dark:bg-opacity-5 shadow'>

                {/* logo start */}
                <div className='flex items-center gap-5 text-lg sm:text-xl md:text-2xl lg:text-3xl'>
                ...
                <div className='flex items-center gap-3'>
                    <div>
                        <motion.button
                            whileTap={{ scale: 0.9 }}
                            className='bg-red-400 text-white dark:bg-white dark:text-red-400 p-2 sm:p-3 rounded-full'
