...
interface ISomethingProps {
}

const Something: React.FunctionComponent<ISomethingProps> = (props) => {
  return <>
    {/* component */}
            ...
            <div className="capitalize">
              <nav aria-label="breadcrumb" className="w-max">
                <ol className="flex flex-wrap items-center w-full bg-opacity-60 rounded-md bg-transparent p-0 transition-all">
                  ...
                  <li className="flex items-center text-blue-900 antialiased font-sans text-sm font-normal leading-normal  transition-colors duration-300 hover:text-blue-500">
